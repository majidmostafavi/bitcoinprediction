...
class TrainerController(object):
    ...
    def start_learning(self, env_manager: EnvManager) -> None:
        ...
        global_step = 0
        last_brain_behavior_ids: Set[str] = set([1])
        try:
            # Initial reset
            self._reset_env(env_manager)
            while self._not_done_training() and global_step<self.n_steps:
    ...
    # @timed
    def advance(self, env: EnvManager):
        # Get steps
