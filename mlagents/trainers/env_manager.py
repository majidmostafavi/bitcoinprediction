...
from mlagents.base_env import BatchedStepResult, AgentGroupSpec, AgentGroup
...
class EnvManager(ABC):
    ...
    def advance(self):
        ...
        # print("new_step_infos")
        # print(new_step_infos)
        # Add to AgentProcessor
        num_step_infos = self._process_step_infos(new_step_infos)
        # num_step_infos = {"done":new_step_infos.current_all_step_result[self.env.spec.id].done[0]}
