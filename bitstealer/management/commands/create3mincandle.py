...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        start_date = datetime.datetime(2020, 2, 24, 13, 58) #TODO BINACNE STARTED DATE
        ...
        while start_date < datetime.datetime.now():
            ...
            for i in candles:
                ...
                if i.price < low_candle or low_candle == 0:
                    low_candle = i.price
            item = Min3Candle(symbol="BTCUSDT", date=start_date, open=open_candle, close=close_candle, low=low_candle,
