...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        feature_pipeline = FeaturePipeline(steps=[normalized_volume, macd, cci])
        ...
        if train:
            for i in range(iteration):
                print('*-------------- iteration =', i+1, ' --------------*')
                try:
                    strategy.restore_agent(path="./tensortrade/agents/train_5", custom_objects=custom_objects)
                ...
                strategy.save_agent(path="./tensortrade/agents/train_5")
            ...
            strategy.restore_agent(path="./tensortrade/agents/train_5")
