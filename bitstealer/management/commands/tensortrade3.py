    ...
    def handle(self, *args, **kwargs):
        ...
        if train:
            for i in range(iteration):
                print('*-------------- iteration =', i+1, ' --------------*')
                try:
                    strategy.restore_agent(path="./tensortrade/agents/train_3", custom_objects=custom_objects)
                ...
                strategy.save_agent(path="./tensortrade/agents/train_3")
            ...
            strategy.restore_agent(path="./tensortrade/agents/train_3")
