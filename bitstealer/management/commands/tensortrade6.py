...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        feature_pipeline = FeaturePipeline(steps=[normalized_volume, macd, stochastic])
        ...
        if train:
            for i in range(iteration):
                print('*-------------- iteration =', i+1, ' --------------*')
                try:
                    strategy.restore_agent(path="./tensortrade/agents/train_6", custom_objects=custom_objects)
                ...
                strategy.save_agent(path="./tensortrade/agents/train_6")
            ...
            strategy.restore_agent(path="./tensortrade/agents/train_6")
